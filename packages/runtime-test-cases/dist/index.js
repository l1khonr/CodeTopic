...
exports.RuntimeTestCases = void 0;
class RuntimeTestCases {
    constructor() {
        this.testCases = [
            // Node.js Tests
            {
                ...
                validation: (output) => output.includes('Child process output'),
            },
            {
                ...
                validation: (output) => output.includes('Promise resolved'),
            },
            {
                ...
                validation: (output) => output.includes('Hello World'),
            },
            {
                ...
                validation: (output) => output.includes('Server running'),
            },
            {
                ...
                validation: (output) => output.includes('Stream data'),
            },
            {
                ...
                validation: (output) => output.includes('Event emitted'),
            },
            // Package Manager Tests
            {
                ...
                validation: (output) => output.includes('helloWorld'),
            },
            {
                ...
                validation: (output) => output.includes('Axios installed successfully'),
            },
            {
                ...
                validation: (output) => output.includes('PNPM test passed'),
            },
            // CLI Tests
            {
                ...
                validation: (output) => output.includes('Hello CLI'),
            },
            // Vite Tests
            {
                ...
                validation: (output) => output.includes('build complete'),
            },
            // Next.js Tests
            {
                ...
                validation: (output) => output.includes('Next.js'),
            },
            // shadcn-ui Tests
            {
                ...
                validation: (output) => output.includes('shadcn-ui components added'),
            },
            // React Router Tests
            {
                ...
                validation: (output) => output.includes('React Router ready'),
            },
            // Nuxt Tests
            {
                name: 'Nuxt Setup',
                ...
                validation: (output) => output.includes('build finished'),
            },
            // LibSQL Tests
            {
                ...
                validation: (output) => output.includes('LibSQL table created'),
            },
            // Drizzle ORM Tests
            {
                ...
                validation: (output) => output.includes('Drizzle ORM initialized'),
            },
        ];
    }
    /**
     ...
     */
    async runTest(testCase, runtime = 'node') {
     ...
     */
    async runCategoryTests(category, runtime = 'node') {
     ...
     * Run all test cases
     */
    async runAllTests(runtime = 'node') {
        const results = [];
...
exports.RuntimeTestCases = RuntimeTestCases;
exports.default = RuntimeTestCases;
